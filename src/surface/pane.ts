  ...
  public replaceSurface(newChild: Surface, callback: (pane: Pane) => void, transition?: string, duration?: number) {
    if (transition !== undefined && duration !== undefined) {
      switch (transition.toLowerCase()) {
        ...
        case 'revealleftdown':
          {
            const t = new RevealTransition(this, newChild, callback, duration, TransitionDirection.LeftDown);
            t.start();
          }
          break;
        ...
        case 'revealrightdown':
          {
            const t = new RevealTransition(this, newChild, callback, duration, TransitionDirection.RightDown);
            t.start();
          }
          break;
        ...
        case 'sliderightdown':
          {
            const t = new SlideTransition(this, newChild, callback, duration, TransitionDirection.RightDown);
            t.start();
          }
          break;
