...
export class ElementBase implements IPointContainer {
     ...
     * Element fill stack
     */
    public fillStack?: any[];

    /**
     * Element stroke stack
     */
    public strokeStack?: any[];
     ...
     */
    set size(newValue: string | undefined) {
        if (!newValue) {
     ...
     */
    set location(newValue: string | undefined) {
        if (!newValue) {
    ...
    public hitTest(c: CanvasRenderingContext2D, tx: number, ty: number): boolean {
        if(!this._size || !this._location || !this.model) {
            return false;
        }
     ...
     * @returns This element
     */
    public setSize(sizeSource: string | Size): ElementBase {
     ...
     * @returns This element
     */
    public setFillScale(fillScale: number) {
     ...
     * @returns This element
     */
    public setFillOffsetX(fillOffsetX: number) {
     ...
     * @returns This element
     */
    public setFillOffsetY(fillOffsetY: number) {
     ...
     */
    public notImplemented(subject: string) {
