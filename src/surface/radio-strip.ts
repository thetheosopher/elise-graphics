...
export class RadioStrip extends LayeredSurfaceElement {
    ...
    public prepare(callback: (success: boolean) => void) {
        ...
        commandHandler.addHandler(RadioStrip.RADIO_BUTTON_CLICK, (
        ...
        commandHandler.addHandler(RadioStrip.RADIO_BUTTON_DOWN, (
            controller: IController,
            element: ElementBase,
            command: string,
            trigger: string,
        ...
        commandHandler.addHandler(RadioStrip.RADIO_BUTTON_UP, (
            controller: IController,
            element: ElementBase,
            command: string,
            trigger: string,
