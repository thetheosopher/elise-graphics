...
export class WipeTransition extends PaneTransition {
        ...
        case TransitionDirection.Out:
          {
            ...
            self.target.div.style.clip = 'rect(' + halfY + 'px, ' + halfX + 'px, ' + halfY + 'px, ' + halfX + 'px)';
          }
          break;
  ...
  public tick() {
    ...
    if (!this.source.div) {
      throw new Error('Source div is undefined.');
    }
    if (!this.target.div) {
      throw new Error('Target div is undefined.');
    }
        ...
        case TransitionDirection.OutX:
          {
            ...
            const offsetX = Math.floor((offset * this.pane.width * this.pane.surface.scale) / 2);
            this.target.div.style.clip =
              'rect(' + 0 + 'px, ' + (halfX + offsetX) + 'px, ' + height + 'px, ' + (halfX - offsetX) + 'px)';
          }
          break;
        ...
        case TransitionDirection.OutY:
          {
            ...
            const offsetY = Math.floor((offset * this.pane.height * this.pane.surface.scale) / 2);
            this.target.div.style.clip =
              'rect(' + (halfY - offsetY) + 'px, ' + width + 'px, ' + (halfY + offsetY) + 'px, ' + 0 + 'px)';
          }
          break;
        ...
        case TransitionDirection.In:
          {
            ...
            const offsetY = Math.floor((offset * this.pane.height * this.pane.surface.scale) / 2);
            this.source.div.style.clip =
              'rect(' + offsetY + 'px, ' + (width - offsetX) + 'px, ' + (height - offsetY) + 'px, ' + offsetX + 'px)';
          }
          break;
