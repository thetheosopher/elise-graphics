...
export class TransitionRenderer {
    ...
    public static pushFrameTransition(c: IController, el: SpriteElement, command: string, trigger: string, parameters: any) {
        if (!el.frameStack) {
            el.frameStack = [];
        }
    ...
    public static popFrameTransition(c: IController, el: SpriteElement, command: string, trigger: string, parameters: any) {
        if (!el.frameStack) {
            return;
        }
        const sourceFrame: number = el.frameIndex;
